...
implica
$\Re (\lambda_{+}) > 0$ y así inestabilidad.
...
\blem El conjunto de tensores simétricos positivos es abierto en el
conjunto de tensores simétricos, es decir si $\ve{\ro}_0$ es simétrico y
positivo y $\ve{\ro}_1 $ es simétrico luego existe $\epsilon > 0$ tal que
$\ve{\ro}_0 + \epsilon \ve{\ro}_1 $ es también positivo.
\elem
...
Si $\ve{x}$ es suficientemente peque\~no, [es decir $|\ve{x}| < C$ para algún $C>0$ suficientemente pequeño] 
se cumple que 
