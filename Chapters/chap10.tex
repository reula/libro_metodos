...
para cualquier función en $\cifrn$, es decir infinitamente diferenciable
...
habríamos
probado que la transformada de Fourier de una función en $\cifrn$
...
$L^2(\ren{})$) de una 
sucesión $\{f_n\}$ de funciones en $\cifrn$, esto nos permite extender la
acción de \cF{} a todo elemento de $L^2(\ren{})$. 
En efecto, sea $f\in L^2(\ren{})$ arbitraria y
sea $\{f_n\}\to f \in\cifrn$ luego la sucesión $\hat f_n(k)=\cF{}(f_n)$ 
satisface,
\beq
