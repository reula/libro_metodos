...
integral de $v^a$.
Claramente podríamos tomar este conjunto a los puntos de $M$
...
propiedad de que cada punto de $S$ determina una única solución, es
...
Si pudiésemos encontrar las derivadas normales a $\Sigma$, si
$\Phi^A$  fuesen datos analíticos, y si los coeficientes de la
ecuación fuesen también analíticos, luego se puede demostrar
...
Estamos pidiendo la posibilidad mínima de tener soluciones.

Si esto no sucede entonces es claro que la ecuación será
una relación entre términos determinados a partir de los datos dados
y en general no se satisfará. En ese caso los datos a dar
libremente serán un número menor al de la dimensión del
espacio de partida, solo se podrán dar algunas componentes de $u^A$.
