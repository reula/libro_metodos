...
Esta condición nos garantiza que $ \langle x,x\rangle $ es un
número real y , junto con $ iii)$, que es no-negativo.
\espa

\ejer:
Pruebe que dando un tensor de tipo $(2,0)$, $\ve{t}\langle\cdot,\cdot\rangle $,
simétrico, real y positivo definido, entonces 
$\langle \ve{x},\ve{y}\rangle  \equiv \ve{t}\langle\bar{\ve{x}},\ve{y}\rangle $ es un producto
escalar.
\espa
...
$$
%
Pero esta es una sucesión creciente (en $k$) de números reales que es
...
\beq\barr{rcl}
d^2 &\equiv &\|x-z\|^2\leq\|x-\langle z+t\,v\rangle\|^2=\|y-t\,v\|^2 \\
...
definido por $\fip_y(x)=\langle y,x\rangle$ es lineal y como $|\fip(x)|\leq\|y\|_H\:\|x\|_H$
...
{\bf relación de Parseval } y los coeficientes $\langle x_n,y\rangle$ los 
