...
obtenido no hereda de $H$ ninguna propiedad interesante por ser éste un
...
$f(x)$ y usado que la integral del núcleo de Dirichlet es uno (\ref{eqn:nucleo=1}).
...
productos escalares:
\begin{enumerate}
\item $\langle f,g \rangle = \int^1_{-1} \bar fg \;dx$ (En este caso obtendrá los
...
Para ello probaremos por inducción que dado $i$, $\langle \ve{u}_i,\ve{u}_j\rangle = 0
\;\forall\; j < i$ positivo.
